...
contract LZEndpointMock is ILayerZeroEndpoint {
    ...
    function getConfig(uint16 /*_version*/, uint16 /*_chainId*/, address /*_ua*/, uint /*_configType*/) external pure override returns (bytes memory) {
        return "";
    }
    ...
    function setConfig(uint16 /*_version*/, uint16 /*_chainId*/, uint /*_configType*/, bytes memory /*_config*/) external override {}
    ...
    function _getRelayerFee(uint16 /* _dstChainId */, uint16 /* _outboundProofType */, address /* _userApplication */, uint _payloadSize, bytes memory _adapterParams) internal view returns (uint) {
